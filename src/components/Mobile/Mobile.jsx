            ...
            <div className="mobile">
                <div className="mobile-desc">
                    <div className="mobile-desc__header">
                        <h4 className="mobile-desc__head">
                            Dropbox Mobile App
                        </h4>
                        ...
                        <p className="mobile-desc__text">
                            ...
                            moving from anywhere, so you can stay focused on{" "}
                            <br /> what matters. Access work, collaborate with
                            co-workers and clients, and quickly take care of
